...
function lafka_shipping_areas_shortcode( $atts = [], $content = null, $tag = '' ): string {
	...
	wp_enqueue_script( 'lafka-shipping-areas-shortcode-' . $shortcode_id, plugins_url( 'assets/js/frontend/lafka-shipping-areas-shortcode.min.js', dirname( __FILE__ ) ), array( 'lafka-google-maps' ), false, true );
	wp_localize_script( 'lafka-shipping-areas-shortcode-' . $shortcode_id, 'lafka_shipping_areas_shortcode_php_variables', array(
