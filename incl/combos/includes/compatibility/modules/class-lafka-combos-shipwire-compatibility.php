 ...
 * @version  5.1.0
 */
class WC_LafkaCombos_Shipwire_Compatibility {
	...
	public static function add_filters() {
		...
		add_filter( 'woocommerce_get_product_from_item', array( WC_LafkaCombos()->order, 'get_product_from_item' ), 10, 3 );
	}
	...
	public static function remove_filters() {
		...
		remove_filter( 'woocommerce_order_get_items', array( WC_LafkaCombos()->order, 'get_order_items' ), 10, 2 );
		remove_filter( 'woocommerce_get_product_from_item', array( WC_LafkaCombos()->order, 'get_product_from_item' ), 10, 3 );
	}
}

WC_LafkaCombos_Shipwire_Compatibility::init();
