 ...
 * @version  6.6.4
 */
class WC_LafkaCombos_Stripe_Compatibility {
	...
	/**
	 * Hide Stripe Quick-pay buttons for non-static Combos.
	 *
	 * @since 6.6.1
	 *
	 */
...
WC_LafkaCombos_Stripe_Compatibility::init();
