	...
	final class Lafka_Config_Bundle {
		...
		public static function business_option_keys(): array {
			return array(
				...
				// GX3 business facts + Search & AI settings.
				'lafka_business_description',
				'lafka_business_map_url',
				'lafka_business_service_areas',
				'lafka_seo_title_home',
				'lafka_seo_title_menu',
				'lafka_seo_title_category',
				'lafka_seo_title_product',
				'lafka_seo_title_page',
				'lafka_seo_title_sep',
