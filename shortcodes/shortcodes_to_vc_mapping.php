...
if ( ! function_exists( 'lafka_integrateWithVC' ) ) {
	...
	function lafka_integrateWithVC() {
		...
		$althem_icon                    = plugins_url( 'assets/image/VC_logo_alth.png', __DIR__ );
		...
		if ( defined( 'WPB_VC_VERSION' ) ) {
			...
			$icon_params = vc_map_integrate_shortcode(
	...
	function lafka_add_dependency_to_product_columns_param() {
		...
		foreach ( $shortcodes_to_update as $shortcode ) {
			...
			$param['dependency'] = array(
				'element'            => 'class',
				'value_not_equal_to' => array( 'lafka-products-list-view lafka-is-shortcode' ),
			);
